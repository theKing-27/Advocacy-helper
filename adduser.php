                        ...
                        <td>
                            ...
                            <td colspan="2">
                                ...
                                <td><input type="password" id="idConfirmPwd" name="txtConfirmPwd"></td> 
                                    ...
                                    <tr>
                                        <td><label id="lblusertype">User Type</label></td>
                                        <td>   <select name="txtUsrType"> 
                                    ...
                                    <td> <input type="radio" name="rbtnStatus" value="active">Active
                            ...
                            <fieldset>
                                ...
                                <td><input id="idDOB" type="text" name="txtDOB"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="radio" name="rbtnGender" value="Male">Male
